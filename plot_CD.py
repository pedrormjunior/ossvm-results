...
classifier_name_map = {
    'evmC': '$\mathrm{EVM}_{\mathrm{C}}$',
    'evmO': '$\mathrm{EVM}_{\mathrm{O}}$',
    'ocsvmC': '$\mathrm{SVM}_{\mathrm{C}}^{\mathrm{OC}}$',
    'ocsvmO': '$\mathrm{SVM}_{\mathrm{O}}^{\mathrm{OC}}$',
    'ssvmC': '$\mathbf{{SSVM}_{C}}$',
    'ssvmO': '$\mathbf{{SSVM}_{O}}$',
    'svddC': '$\mathrm{SVDD}_{\mathrm{C}}$',
    'svddO': '$\mathrm{SVDD}_{\mathrm{O}}$',
    'svmC': '$\mathrm{SVM}_{\mathrm{C}}$',
    'svmO': '$\mathrm{SVM}_{\mathrm{O}}$',
    'svmdbcC': '$\mathrm{DBC}_{\mathrm{C}}$',
    'svmdbcO': '$\mathrm{DBC}_{\mathrm{O}}$',
    'pisvmC': '$\mathrm{PISVM}_{\mathrm{C}}$',
    'pisvmO': '$\mathrm{PISVM}_{\mathrm{O}}$',
    'onevsetC': '$\mathrm{1VS}_{\mathrm{C}}$',
    'onevsetO': '$\mathrm{1VS}_{\mathrm{O}}$',
    'wsvmC': '$\mathrm{WSVM}_{\mathrm{C}}$',
    'wsvmO': '$\mathrm{WSVM}_{\mathrm{O}}$',
}
